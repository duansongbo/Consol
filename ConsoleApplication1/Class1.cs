...
namespace ConsoleApplication1
{
    public  class Tools_TestGrid 
    {
        ...
        public void Page_Load()
        {
            ...
            Console.WriteLine("基本方法:" + ts.TotalMilliseconds + "<br/>");
            ...
            Console.WriteLine("反射方法:" + ts.TotalMilliseconds + "<br/>");
            ...
            ts = DateTime.Now - time;
            Console.WriteLine("泛型委托赋值方法:" + ts.TotalMilliseconds + "<br/>");
            Console.WriteLine("v:" + d.Name + "<br/>");
            ...
            ts = DateTime.Now - time;
            Console.WriteLine("泛型委托取值方法:" + ts.TotalMilliseconds + "<br/>");
            Console.WriteLine("v:" + d.Name + "<br/>");
            ...
            ts = DateTime.Now - time;
            Console.WriteLine("表达式树赋值方法:" + ts.TotalMilliseconds + "<br/>");
            Console.WriteLine("v:" + d.Name + "<br/>");
            ...
            ts = DateTime.Now - time;
            Console.WriteLine("表达式树取值方法:" + ts.TotalMilliseconds + "<br/>");
            Console.WriteLine("v:" + this.LmdGetProp(d) + "<br/>");
            ...
            ts = DateTime.Now - time;
            Console.WriteLine("EMIT动态方法:" + ts.TotalMilliseconds + "<br/>");
            Console.WriteLine("v:" + d.Name + "<br/>");
            //TestDataBind();
        }
